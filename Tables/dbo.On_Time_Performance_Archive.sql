CREATE TABLE [dbo].[On_Time_Performance_Archive]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_dbo_On_Time_Performance_Archive] ON [dbo].[On_Time_Performance_Archive] ON [DATA01]
GO
